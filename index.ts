...
class User {
    ...
    constructor(username: string, userid: string, password: any, balance: number = 0) {
    ...
    static async viewAndBookEvents(events: any[]) {
        if (events.length === 0) {
        ...
        if (confirmBooking) {
            ...
            console.log(chalk.bgCyan.bold("your will be sent via email"))
        }
    }
}
